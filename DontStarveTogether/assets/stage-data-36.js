...
window.CRAFTING_PLAN_DATA = {
  ...
  materials: {
    "草": { icon: "草_cut-grass.png" }, "树枝": { icon: "树枝_twigs.png" }, "木头": { icon: "木头_log.png" },
    "燧石": { icon: "燧石_flint.png" }, "石头": { icon: "石头_rocks.png" }, "金子": { icon: "金子_gold-nugget.png" },
    "齿轮": { icon: "齿轮_gears.png" }, "猪皮": { icon: "猪皮_pig-skin.png" }, "大肉": { icon: "大肉_meat.png" },
    "蛛丝": { icon: "蛛丝_silk.png" }, "活兔": { icon: "活兔_rabbit.png" }, "荧光果": { icon: "荧光果_light-bulb.png" },
    "萤火虫": { icon: "萤火虫_fireflies.png" }, "木炭": { icon: "木炭_charcoal.png" }, "种子": { icon: "种子_seeds.png" },
    "芦苇": { icon: "芦苇_cut-reeds.png" }, "骨渣": { icon: "骨渣_bone-shard.png" }, "粪": { icon: "粪_manure.png" },
    "牛角": { icon: "牛角_beefalo-horn.png" }, "牛毛": { icon: "牛毛_beefalo-wool.png" }, "海象牙": { icon: "海象牙_walrus-tusk.png" },
    "冰": { icon: "冰_ice.png" }, "番茄": { icon: "种子_seeds.png" }, "其他蔬菜": { icon: "种子_seeds.png" },
    "独眼巨鹿眼球": { icon: "独眼巨鹿眼球_deerclops-eyeball.png" }, "骨片": { icon: "骨渣_bone-shard.png" },
    "触手皮": { icon: "触手皮_tentacle-spots.png" }
  },
  stages: {
    explore: {
      defaults: { "斧头": 4, "石镐": 4, "火把": 8, "背包": 4, "科学机器": 1, "炼金引擎": 1, "灵子分解器": 1, "木甲": 4, "猪皮帽": 1, "火腿棒": 1, "长矛": 1, "提灯": 1, "矿工帽": 1, "礼帽": 1 },
      recipes: {
        "斧头": { "树枝": 1, "燧石": 1 }, "石镐": { "树枝": 2, "燧石": 2 }, "火把": { "草": 2, "树枝": 2 },
        "背包": { "草": 4, "树枝": 4 }, "科学机器": { "木头": 4, "石头": 4, "金子": 1 },
        "炼金引擎": { "木板": 4, "石砖": 2, "电子元件": 2 }, "灵子分解器": { "活兔": 4, "木板": 4, "礼帽": 1 },
        "木甲": { "木头": 8, "绳子": 2 }, "猪皮帽": { "猪皮": 1, "绳子": 1 }, "火腿棒": { "猪皮": 1, "树枝": 2, "大肉": 2 },
        "长矛": { "树枝": 2, "燧石": 1, "绳子": 1 }, "提灯": { "树枝": 3, "绳子": 2, "荧光果": 2 },
        "矿工帽": { "草帽": 1, "金子": 1, "萤火虫": 1 }, "礼帽": { "蛛丝": 6 }
      }
    },
    base: {
      defaults: { "冰箱": 1, "烹饪锅": 3, "石头火坑": 1, "木箱": 4, "鸟笼": 1, "捕鸟陷阱": 1, "晾肉架": 4, "耕地机": 1, "锄头": 1, "喷壶": 1, "粪盆": 1, "园艺帽": 1, "皮弗娄牛铃": 1 },
      recipes: {
        "冰箱": { "金子": 2, "齿轮": 1, "石砖": 1 }, "烹饪锅": { "石砖": 3, "木炭": 6, "树枝": 6 },
        "石头火坑": { "木头": 2, "石头": 12 }, "木箱": { "木板": 3 }, "鸟笼": { "纸": 2, "种子": 2, "金子": 6 },
        "捕鸟陷阱": { "树枝": 3, "蛛丝": 4 }, "晾肉架": { "树枝": 3, "木炭": 2, "绳子": 3 },
        "耕地机": { "木板": 3, "绳子": 2, "燧石": 2 }, "锄头": { "树枝": 2, "燧石": 2 },
        "喷壶": { "木板": 2, "绳子": 1 }, "粪盆": { "木头": 4, "骨渣": 2, "粪": 3 },
        "园艺帽": { "粪盆": 1, "种子": 3, "电子元件": 1 }, "皮弗娄牛铃": { "金子": 3, "燧石": 1 }
      }
    },
    prewinter: {
      defaults: { "皮牛帽": 1, "热能石": 4, "火把": 8 },
      recipes: { "皮牛帽": { "牛角": 1, "牛毛": 8 }, "热能石": { "石头": 10, "石镐": 1, "燧石": 3 }, "火把": { "草": 2, "树枝": 2 } }
    },
    winter: {
      defaults: { "步行手杖": 1, "蔬菜鸡尾酒": 4 },
      recipes: { "步行手杖": { "海象牙": 1, "金子": 2, "树枝": 4 }, "蔬菜鸡尾酒": { "番茄": 2, "其他蔬菜": 1, "冰": 1 } }
    },
    deerclops: {
      defaults: { "告示牌": 1, "营火": 1, "新鲜火腿棒": 4 },
      recipes: { "告示牌": { "木板": 1 }, "营火": { "木头": 2, "草": 3 }, "新鲜火腿棒": { "猪皮": 1, "树枝": 2, "大肉": 2 } }
    },
    spring: {
      defaults: { "眼球伞": 1, "避雷针": 1, "猪皮帽 + 雨伞": 3, "雨衣": 0 },
      recipes: {
        "眼球伞": { "独眼巨鹿眼球": 1, "树枝": 15, "骨片": 4 }, "避雷针": { "金子": 4, "石砖": 1 },
        "猪皮帽 + 雨伞": { "猪皮帽": 1, "雨伞": 1 }, "雨衣": { "触手皮": 2, "绳子": 2, "骨片": 2 }
      }
    }
  }
};
